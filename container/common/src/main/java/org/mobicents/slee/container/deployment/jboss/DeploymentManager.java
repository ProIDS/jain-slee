    ...
    for (ManagementAction action : actions) {
      ...
      try {
        ...
        if (e.getCause() instanceof ResourceAdaptorEntityAlreadyExistsException || (e.getCause() instanceof InvalidStateException
          ...
          //TODO ??
          else if (action instanceof ActivateResourceAdaptorEntityAction) {
            actionToAvoid = GracefulShutdownResourceAdaptorEntityAction.class;
          }
        ...
        //TODO
        else if (e.getCause() instanceof InvalidStateException && action instanceof GracefulShutdownResourceAdaptorEntityAction) {
          // ignore this... someone has already deactivated the link.
        }
