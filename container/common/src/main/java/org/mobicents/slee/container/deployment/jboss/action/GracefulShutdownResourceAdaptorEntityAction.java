 ...
 *
 */
public class GracefulShutdownResourceAdaptorEntityAction extends
    ResourceManagementAction {

	private final String raEntityName;

	public GracefulShutdownResourceAdaptorEntityAction(String raEntityName,
	...
	public void invoke() throws Exception {
		...
		if (resourceAdaptorEntity != null) {
			...
			if (resourceAdaptorEntity.getState() == ResourceAdaptorEntityState.ACTIVE) {
				//TODO
        resourceManagement.gracefulShutdownResourceAdaptorEntity(raEntityName, 300, 1000L);
//				resourceManagement.deactivateResourceAdaptorEntity(raEntityName);
	...
	public String toString() {
		return "GracefulShutdownResourceAdaptorEntityAction[" + raEntityName + "]";
	}
